  ...
  <div class="row">
    <div class="col-2">
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <a class="nav-link" id="v-pills-pesantren-tab" data-toggle="pill" href="#v-pills-pesantren" role="tab" aria-controls="v-pills-pesantren" aria-selected="false"><img src="<?= LOCAL; ?>/CDN/img/santren.svg" class="special-icon">&nbsp;Pesantren</a>
      </div>
    </div>
    <div class="col-10">
